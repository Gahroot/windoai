        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-invert max-w-none space-y-8">
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                {config.brandName} provides AI-powered receptionist and lead management services for window and door companies. Our services include automated lead response, lead qualification, estimate scheduling, and follow-up communications via SMS/text messaging and other channels. Our AI agent engages with leads on behalf of our clients to facilitate window and door project bookings.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                If you are a window or door company using {config.brandName} services, you additionally agree to:
              </p>
              <ul className="list-disc list-inside text-muted-foreground space-y-2">
                ...
                <li>Use our services only for legitimate window and door business purposes</li>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                You acknowledge that communications from {config.brandName} may be generated by artificial intelligence. While we strive for accuracy, AI-generated content may occasionally contain errors. Our AI agent operates under the supervision of our clients and is designed to facilitate, not replace, human interaction in the sales and scheduling process.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                Our services are provided &quot;as is&quot; and &quot;as available&quot; without warranties of any kind, either express or implied. We do not guarantee that our services will be uninterrupted, error-free, or secure. We are not responsible for the outcome of any business transactions facilitated through our platform.
              </p>
            </section>
